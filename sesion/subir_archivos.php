...
$res[3] = ($res[3] == 'admin') ? "": header("Location: ../index.php");
            ...
            <div id="main-flex-wrapper" class="main-flex-wrapper full-main">
                <div id="main-card" class="card">
                    <div class="card__header">
                        <h2 class="card__title">Subir volante de pago</h2>
                       
                    </div>
                    <div class="card__body">
                        <form action="../js/file.php" class="dropzone" id="my-dropzone" method="post">
